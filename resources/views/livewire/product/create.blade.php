<div x-data="{state : $wire.entangle('state')}"
    ...
    <div class="my-container grid gap-4 w-1/3" wire:click.outside="$set('state',false)">
        ...
        <div class="grid gap-1">
            ...
            <textarea class="input" rows="3" wire:model="data.note"
                      placeholder="Məhsul haqqında qeydlərinizi buraya qeyd edin..."></textarea>
        </div>
        <div class="grid gap-1">
        ...
        <button wire:loading.class="!hidden" wire:target="create" wire:click="create"
                class="btn btn-large btn-primary inline-flex items-center justify-center gap-1.5">
            <svg class="size-6" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
        ...
        <p wire:loading wire:target="create" class="loading-text">Sorğunuz icra olunur...</p>
    </div>
</div>
