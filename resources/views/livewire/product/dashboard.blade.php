        ...
        <div class="grid gap-3 flex-1">
            <div class="flex flex-wrap gap-3">
                ...
                <div class="p-4 rounded-lg shadow-lg bg-white flex items-center space-x-4">
                    ...
                    <div>
                        <p class="text-gray-800 text-lg font-semibold">
                            {{$this->summary["active"]["count"]}}
                        </p>
                        <p class="text-gray-600 text-sm">
                            {{$this->summary["active"]["name"]}}
                        </p>
                    </div>
                </div>
                <div class="p-4 rounded-lg shadow-lg bg-white flex items-center space-x-4">
                    ...
                    <div>
                        <p class="text-gray-800 text-lg font-semibold">
                            {{$this->summary["passive"]["count"]}}
                        </p>
                        <p class="text-gray-600 text-sm">
                            {{$this->summary["passive"]["name"]}}
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    @foreach($this->products as $product)
                        <tr>
                            <td class="whitespace-nowrap">
                                <button wire:click="$dispatch('product.edit',{ id : {{$product->id}} })"
