        ...
        <div class="grid gap-3 flex-1">
            <div class="flex flex-wrap gap-3">
                <div class="my-container grid">
                    <p class="text-xl font-bold ml-auto">{{\App\Models\Product::count()}} ədəd</p>
                    <p class="text-sm">Bütün məhsullar</p>
                </div>
                <div class="my-container grid">
                    <p class="text-xl font-bold ml-auto">{{\App\Models\Product::where("visible",true)->count()}} ədəd</p>
                    <p class="text-sm">Aktiv məhsullar</p>
                </div>
                <div class="my-container grid">
                    <p class="text-xl font-bold ml-auto">{{\App\Models\Product::where("visible",false)->count()}} ədəd</p>
                    ...
                    @foreach($this->products as $product)
                        <tr>
                            <td class="whitespace-nowrap">
                                <button wire:click="select({{$product->id}})" class="my-input inline-flex items-center gap-1.5 !p-2.5 text-sm font-medium">
