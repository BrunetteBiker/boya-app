<div class="grid gap-4">
    ...
    <div class="flex flex-wrap items-start gap-3">
        ...
        <div class="p-4 rounded-lg shadow-lg bg-white flex items-center gap-4">
            ...
            <div>
                <p class="text-gray-800 text-lg font-semibold">
                    {{$this->summary["daily"]["count"]}}
                </p>
                <p class="text-gray-600 text-sm">{{$this->summary["daily"]["name"]}}</p>
            </div>
        </div>
        <div class="p-4 rounded-lg shadow-lg bg-white flex items-center gap-4">
            <svg class="size-10" viewBox="0 0 32 32">
            ...
            <div>
                <p class="text-gray-800 text-lg font-semibold">
                    {{$this->summary["weekly"]["count"]}}
                </p>
                <p class="text-gray-600 text-sm">{{$this->summary["weekly"]["name"]}}</p>
            </div>
        </div>
        <div class="p-4 rounded-lg shadow-lg bg-white flex items-center gap-4">
            <svg class="size-10" viewBox="0 0 32 32">
    ...
    <div class="flex items-start gap-4">
            ...
            <div class="overflow-auto">
                <table class="custom-table">
                    ...
                    @foreach($this->items as $item)
                        <tr>
                            <td>
                                <a href="{{url("order/details/$item->order_id")}}"
        ...
        <div class="my-container w-80 grid gap-3">
            ...
            <p>
                Tapıldı : <strong>{{$filters["result"]}} ədəd</strong>
            </p>
