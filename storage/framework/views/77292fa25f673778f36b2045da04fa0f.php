        ...
        stroke-miterlimit: 10;
                ...
                <div>
                    <p class="text-gray-800 text-lg font-semibold">
                        ...
                        <span><?php echo e($this->summary["all"]["funds"]); ?></span>
                    </p>
            ...
            <div class="p-4 rounded-lg shadow-lg bg-white flex items-center gap-4">
                ...
                <div>
                    <p class="text-gray-800 text-lg font-semibold">
                        <span><?php echo e($this->summary["hasDebt"]["count"]); ?></span> |
                        <span><?php echo e($this->summary["hasDebt"]["funds"]); ?></span>
                    </p>
                    <p class="text-gray-600 text-sm"><?php echo e($this->summary["hasDebt"]["name"]); ?></p>
                </div>
            </div>
            <div class="p-4 rounded-lg shadow-lg bg-white flex items-center gap-4">
                ...
                <div>
                    <p class="text-gray-800 text-lg font-semibold">
                        ...
                        <span><?php echo e($this->summary["cancelled"]["funds"]); ?></span>
                    </p>
 ...
 <defs>
     <style type="text/css">
         ...
         >
                ...
                <div>
                    <p class="text-gray-800 text-lg font-semibold">
                        <span><?php echo e($this->summary["inProgress"]["count"]); ?></span> |
                        <span><?php echo e($this->summary["inProgress"]["funds"]); ?></span>
                    </p>
                    <p class="text-gray-600 text-sm"><?php echo e($this->summary["inProgress"]["name"]); ?></p>
                </div>
            </div>
            <div class="p-4 rounded-lg shadow-lg bg-white flex items-center gap-4">
                ...
                <div>
                    <p class="text-gray-800 text-lg font-semibold">
                        <span><?php echo e($this->summary["completed"]["count"]); ?></span> |
                        <span><?php echo e($this->summary["completed"]["funds"]); ?></span>
                    </p>
                    <p class="text-gray-600 text-sm"><?php echo e($this->summary["completed"]["name"]); ?></p>
                </div>
            </div>
            <div class="p-4 rounded-lg shadow-lg bg-white flex items-center gap-4">
                <svg class="w-10 h-10 text-gray-500" xmlns="http://www.w3.org/2000/svg"
...
<style type="text/css">
    ...
    .st3 {
        fill: none;
                ...
                <div>
                    <p class="text-gray-800 text-lg font-semibold">
                        <span><?php echo e($this->summary["delivered"]["count"]); ?></span> |
                        <span><?php echo e($this->summary["delivered"]["funds"]); ?></span>
                    </p>
                    <p class="text-gray-600 text-sm"><?php echo e($this->summary["delivered"]["name"]); ?></p>
                </div>
            </div>
        </div>
        <div class="flex flex-wrap gap-3">
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->timeSummary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $timeSummary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="p-4 rounded-lg shadow-lg bg-white flex items-center gap-4">
                    ...
                    <div>
                        <p class="text-gray-800 text-lg font-semibold">
                            <span><?php echo e($timeSummary["count"]); ?></span>
                        </p>
        ...
        <div class="my-container flex items-center gap-3">
            <p class="text-sm leading-none">Tapıldı : <strong class="font-bold"> <?php echo e($this->orders->total()); ?>
            ...
            <div class="flex gap-3 ml-auto">
                ...
                <a href="<?php echo e(url("order/create")); ?>"
        ...
        <div class="my-container grid gap-4">
            <div class="overflow-auto whitespace-nowrap">
                <table class="custom-table">
                    ...
                    <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $this->orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <a href="<?php echo e(url("order/details/$order->id")); ?>"
        ...
        <div class="grid gap-1">
            ...
            <div class="grid gap-2">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = \App\Models\OrderStatus::orderBy("name","asc")->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label for="order-status-<?php echo e($status->id); ?>" class="input cursor-pointer">
