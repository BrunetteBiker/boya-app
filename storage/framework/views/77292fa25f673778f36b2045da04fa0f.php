    ...
    <div class="flex-1 grid gap-4">
        <div class="flex flex-wrap gap-3">
            <div class="p-4 rounded-lg shadow-lg bg-white flex items-center space-x-4">
                <svg class="w-10 h-10 text-gray-500" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                     y="0px"
    ...
    .st0{fill:none;stroke:#000000;stroke-width:2;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;}
            ...
            <div class="p-4 rounded-lg shadow-lg bg-white flex items-center space-x-4">
                <svg class="w-10 h-10 text-gray-500" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M62 9C62 8.45 61.55 8 61 8H58C57.45 8 57 8.45 57 9C57 9.55 57.45 10 58 10H61C61.55 10 62 9.55 62 9Z"
                          fill="black"/>
                    <path
                    ...
                    <path
                        ...
                        fill="black"/>
                    <path d="M54 5V3C54 2.45 53.55 2 53 2C52.45 2 52 2.45 52 3V5C52 5.55 52.45 6 53 6C53.55 6 54 5.55 54 5Z"
                          fill="black"/>
                    <path
