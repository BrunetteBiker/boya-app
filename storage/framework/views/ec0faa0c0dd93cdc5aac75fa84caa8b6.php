<div
    ...
    <div class="my-container grid gap-4 w-1/3">
        ...
        <div class="grid gap-1">
            ...
            <textarea class="my-input" rows="3" wire:model="newProduct.note" placeholder="Məhsul haqqında qeydlərinizi buraya qeyd edin..."></textarea>
        </div>
        <div class="grid gap-1">
            <div class="text-sm font-medium">Status</div>
            <select class="my-input" wire:model="newProduct.visible">
        ...
        <div class="flex justify-end gap-2">
            <button wire:click="create" type="submit"
                    class="my-input text-sm font-medium transition hover:text-green-600 inline-flex items-center gap-1">
            ...
            <button wire:click="$toggle('newProduct.state')" type="submit"
                    class="my-input text-sm font-medium transition hover:text-red-600 inline-flex items-center gap-1">
